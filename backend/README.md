...
## Project Structure
    ...
    ├── testapiautostorybo_119174  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_119174`
...
2. Clone this repo and `cd testapiautostorybo_119174`
